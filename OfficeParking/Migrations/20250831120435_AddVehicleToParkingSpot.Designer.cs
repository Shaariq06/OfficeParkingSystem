...
namespace OfficeParking.Migrations
{
    ...
    [Migration("20250831120435_AddVehicleToParkingSpot")]
    partial class AddVehicleToParkingSpot
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OfficeParkingSystem.Models.Domain.ParkingSpot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("OfficeParkingSystem.Models.Domain.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("OfficeParkingSystem.Models.Domain.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OfficeParkingSystem.Models.Domain.ParkingSpot", b =>
                {
                    b.HasOne("OfficeParkingSystem.Models.Domain.User", "OccupiedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("OfficeParkingSystem.Models.Domain.Vehicle", b =>
                {
                    b.HasOne("OfficeParkingSystem.Models.Domain.User", "User")
                        .WithMany("Vehicles")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
